				...
				<h1 class="page-title">
					<?php
						...
						elseif ( is_author() ) :
							...
							*/
							the_post();
							printf( __( 'Author: %s', 'market' ), '<span class="vcard">' . get_the_author() . '</span>' );
						...
						elseif ( is_day() ) :
							printf( __( 'Day: %s', 'market' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'market' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
